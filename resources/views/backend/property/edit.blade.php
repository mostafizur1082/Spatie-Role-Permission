...
<div class="page-content">
        ...
        <div class="row profile-body">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
			...
			<form class="forms-sample" method="post" action="{{ route('update.property',$property->id) }}">
				@csrf
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ $property->icon }}">
			          @error('icon')
			          <span class="text-danger">{{ $message }}</span>
			          @enderror
				</div>
